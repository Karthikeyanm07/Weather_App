...
import MapTypeDropdown from "./components/dropdowns/MapTypeDropdowns";
...
function App() {
	...
	return (
		<>
			...
			<div className="flex flex-col gap-8 pt-8 p-8 xs:pt-8 lg:w-[calc(100dvw-var-(sidebar-width))] 2xl:h-screen 2xl:min-h-[1120px]">
